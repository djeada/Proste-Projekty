...
class Gui:
    def __init__(self, root):
        ...
        self.message_label = tk.Label(frame1, text="Message:", font=("Arial", 12))
        ...
        self.key_label = tk.Label(frame2, text="Key:       ", font=("Arial", 12))
        ...
        self.cipher_decipher_label = tk.Label(
            frame3, text="Mode:     ", font=("Arial", 12)
        )
        self.cipher_decipher_label.pack(side=tk.LEFT)

        self.cipher_decipher_dropdown = tk.OptionMenu(
            frame3,
        ...
        self.cipher_button = tk.Button(
            frame5, text="Run", command=self.run_algorithm, font=("Arial", 12)
        )
