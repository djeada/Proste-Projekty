...
from projekty.python.yahtzee.src.gui.dice_gui import DiceGui
from projekty.python.yahtzee.src.gui.possible_moves_gui import PossibleMovesGui
from projekty.python.yahtzee.src.gui.sytled_window import StyledWindow
from projekty.python.yahtzee.src.gui.table_gui import TableGui
from projekty.python.yahtzee.src.logic.game import Game
