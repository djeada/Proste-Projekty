...
from projekty.python.yahtzee.src.logic.dice_to_rule_mapper import DiceToRulesMapper
from projekty.python.yahtzee.src.logic.table import Table, ScoreType
